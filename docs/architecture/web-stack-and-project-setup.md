...
File: `docs/architecture/web-stack-and-project-setup.md`
...
- The backend wraps MBTA v3 and exposes the endpoints defined in `docs/data/data-layer-and-api-reference.md`.
