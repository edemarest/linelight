...
File: `docs/plans/refactor-plan-web-app.md`
...
1. In `packages/core/`, create:
   ...
   - `src/models/` containing TypeScript definitions from `docs/data/data-layer-and-api-reference.md`.
...
1. Point it to docs:
   - `docs/data/data-layer-and-api-reference.md`
   - `docs/architecture/web-stack-and-project-setup.md`
   - `docs/product/web-glance-first-ux-and-feature-spec.md`
   - `docs/data/mbta-eta-strategy-and-integration-guide.md`
   - `docs/plans/refactor-plan-web-app.md` (this file)
