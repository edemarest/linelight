...
File: `docs/data/data-models-and-types.md`

This document defines the core TypeScript data models used in the project. It builds on the conceptual overview in `docs/data/mbta-api-and-data-overview.md` and focuses on:
